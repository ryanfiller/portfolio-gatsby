...
const PortfolioHeader = (props) => {
    ...
    // TODO fix this
    const header = props.children.filter((child) => child.type === 'h2');
    const headerText = header[0].props.children[0]
    const image = props.children.filter((child) => child.type === 'span');
